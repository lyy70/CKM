...
class BN_layer(nn.Module):
    def __init__(self,
        ...
        self.cbam = CBAM(512 * block.expansion)  # 与 bn_layer 输出通道一致
    ...
    def _forward_impl(self, x: Tensor) -> Tensor:
        l1 = self.relu(self.bn2(self.conv2(self.relu(self.bn1(self.conv1(x[0]))))))  # [8,256,16,16]
        l2 = self.relu(self.bn3(self.conv3(x[1])))  # [8,256,16,16]
        feature = torch.cat([l1, l2, x[2]], 1)  # [8,768,16,16]
        output = self.bn_layer(feature)  # [8,512,8,8]
